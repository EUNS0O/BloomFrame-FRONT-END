...
const LOGO_BOTTOM_BUFFER = 4; // 반올림/디센더로 인한 잘림 방지용 여유
const LOGO_DISPLAY_HEIGHT = (LOGO_BBOX.bottom - LOGO_BBOX.top) * LOGO_SCALE + LOGO_BOTTOM_BUFFER;
...
export function TopBar() {
  return (
    <div style={{ padding: "30px 32px 24px", borderBottom: `1px solid ${C.grayLine}`, background: C.bg }}>
      <Logo />
    </div>
  );
}